...
@section('content')
        ...
        <section class="page-section bg-light" id="owner">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Our Amazing owner</h2>
                    <h3 class="section-subheading text-muted">Lorem ipsum dolor sit amet consectetur.</h3>
                </div>
                <div class="row">
                    <div class="col-lg-4">
                        <div class="owner-member">
                            <img class="mx-auto rounded-circle" src="assets/img/owner/1.jpg" alt="..." />
                            <h4>Parveen Anand</h4>
                    ...
                    <div class="col-lg-4">
                        <div class="owner-member">
                            <img class="mx-auto rounded-circle" src="assets/img/owner/2.jpg" alt="..." />
                    ...
                    <div class="col-lg-4">
                        <div class="owner-member">
                            <img class="mx-auto rounded-circle" src="assets/img/owner/3.jpg" alt="..." />
                            <h4>Larry Parker</h4>
